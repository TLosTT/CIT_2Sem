...
const newStudent = await db.query("INSERT INTO STUDENTS (first_name, last_name, group_name, created_at, updated_at) VALUES ($1, $2, $3, $4, $5) RETURNING *",[first_name, last_name , group_name, day1.toISOString(), day1.toISOString()]);
